...
function Brands() {
  ...
  return (
    <div class="container mx-auto p-8 my-32 w-[95%] ">
  <h6 class="text-center decoration ">BRANDS WE WORK WITH</h6>
        <h1 className=' text-5xl  font-semibold text-center  my-12 '>Trusted by Thousands of Businesses</h1>


  <div class="grid grid-cols-1 md:grid-cols-3 gap-[0.15rem] mt-5 border w-[85%] mx-auto">
    {
